...
typedef enum { OK, ERREUR_FICHIER,ERREUR_LECTURE_LARGEUR, ERREUR_LARGEUR_INCORRECTE,ERREUR_LECTURE_HAUTEUR,ERREUR_HAUTEUR_INCORRECTE, ERREUR_LIGNES_MANQUANTES, ERREUR_LIGNE_TROP_COURTE, ERREUR_LIGNE_TROP_LONGUE, ERREUR_CARACTERE_INCORRECT,ERREUR_POSITION_ROBOT_MANQUANTE} erreur_terrain;
